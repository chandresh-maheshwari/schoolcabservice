...
class PermissionName
{
    public static function normalize(?string $routeName): ?string
    {
        ...
        $exactNameMap = [
            ...
            'paymentHistory.index' => 'child.index',
            'paymentHistory.list' => 'child.index',
            'paymentHistory.destroy' => 'child.destroy',
            'paymentHistory.multi-delete' => 'child.destroy',
            'school.paymentHistory.index' => 'child.index',
