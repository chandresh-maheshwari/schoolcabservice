        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Clients Section</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="client-listing-header">Client Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'clientsTable';
                $DatbleVariable['TableCreateRoute'] = 'client.create';
                $DatbleVariable['TableDeleteRoute'] = 'client.destroy';
                $DatbleVariable['TableRestoreRoute'] = 'client.restore';
