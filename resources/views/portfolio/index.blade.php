        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Portfolio Section</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Portfolio Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'portfolioTable';
                $DatbleVariable['TableCreateRoute'] = 'portfolio.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Title', 'Description', 'Image', 'Category', 'Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#portfolioTable";
        let route = '{{ route('portfolio.list') }}';
        let method = "POST";
        ...
        DatatableRenderFunction(
            ...
            pagination,
            multiDelete = true,
            deleteRoute = "portfolio",
            numberOfActivePost = 12,
        );
    });
</script>
@endsection 