        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Child </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Child Listing</h4>
                </div>
        <div class="card-body">
            @php
...
<script>
    $(document).ready(function() {
        let tableId = "#childTable";
        let route = '{{ route('child.list') }}';
        let method = "POST";
