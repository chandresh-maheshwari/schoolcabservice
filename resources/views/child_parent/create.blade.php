...
@section('content')
            ...
            <div class="container">
                <nav aria-label="breadcrumb-nav">
                    <ol class="breadcrumb breadcrumb-style-2 my-20">
                        ...
                        <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Add Child And Parent
                            Details</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="about-us-create-header">Add Child And Parent Details</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="pickup_id" id="pickup_id">
                            ...
                            @foreach ($stops as $stop)
                                <option value="{{ $stop->_id }}">{{ $stop->pickup_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Stop Name <span style="color:red;">*</span></label>
                        <select class="form-control" name="stop_id" id="stop_id">
                            <option value="">Select Stop Name</option>
                            @foreach ($stops as $stop)
                                <option value="{{ $stop->_id }}">{{ $stop->stop_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            fetch('{{ route('api.childParent.store') }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
