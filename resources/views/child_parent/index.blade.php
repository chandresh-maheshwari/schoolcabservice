        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Child/Parent </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Child/Parent Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'childParentTable';
                $DatbleVariable['TableCreateRoute'] = 'childParent.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Father Name','Mother Name', 'Contact Number', 'Child Name','School Name','Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#childParentTable";
        let route = '{{ route('childParent.list') }}';
        let method = "POST";
