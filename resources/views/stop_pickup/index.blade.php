        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Stop Or Pickup Point Listing</h4>
                </div>
        <div class="card-body">
            @php
                ...
                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Route Name', 'PickUp Name', 'Stop Name','Sequence Order','Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#stopPickupTable";
        let route = '{{ route('stopPickup.list') }}';
        let method = "POST";
