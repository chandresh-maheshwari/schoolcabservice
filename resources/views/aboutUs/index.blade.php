        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">About Us Section</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">About Us Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'aboutUsTable';
                $DatbleVariable['TableCreateRoute'] = 'aboutUs.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Title', 'Image', 'Description', 'Profile Name', 'Profile Position', 'Profile Image', 'Contact Number', 'Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#aboutUsTable";
        let route = '{{ route('aboutUs.list') }}';
        let method = "POST";
