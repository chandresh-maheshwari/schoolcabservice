...
@section('content')
            ...
            <div class="container">
                <nav aria-label="breadcrumb-nav">
                    <ol class="breadcrumb breadcrumb-style-2 my-20">
                        ...
                        <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Feature Section</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="about-us-listing-header">Feature Listing</h4>
            </div>
            <div class="card-body">
                @php
                    $DatbleVariable['TableHader'] = '';
                    $DatbleVariable['TableId'] = 'featureTable';
                    $DatbleVariable['TableCreateRoute'] = 'feature.create';
    ...
    <script>
        $(document).ready(function() {
            let tableId = "#featureTable";
            let route = '{{ route('feature.list') }}';
            let method = "POST";
