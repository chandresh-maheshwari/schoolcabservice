...
@section('content')
            ...
            <div class="container">
                <nav aria-label="breadcrumb-nav">
                    <ol class="breadcrumb breadcrumb-style-2 my-20">
                        ...
                        <li class="breadcrumb-item"><a class="breadcrumbLink" href="{{ route('feature.index') }}">Feature</a>
                        </li>
                        <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Edit feature
                            Details</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="feature-edit-header">Edit
                    Features Details</h4>
            </div>
            <div class="card-body">
                <form id="featureForm" enctype="multipart/form-data">
                    ...
                    {{-- <div class="form-group">
                        <label for="image" style="font-weight: bold;">Banners Image <span style="color: red;">*</span></label>
                        <div class="mt-2">
                            ...
                            <span id="imageName">{{ $feature->image ? basename($feature->image) : 'No image selected' }}</span>
                            <img id="imagePreview" src="{{ $feature->image ? asset($feature->image) : '' }}" alt="Image Preview"
                                style="display: {{ $feature->image ? 'block' : 'none' }}; width: 100px; height: 100px; margin-top: 10px;">
                            @if ($feature->image)
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-2">
                            ...
                            <button type="button" class="btn btn-primary" id="uploadImageBtn"
                                ...
                                style="background-color: #2C9DD4; color: white;">Upload Image</button>
                            @php
                                $imagePath = $feature->image ? public_path($feature->image) : null;
                                $imageExists = $imagePath && File::exists($imagePath);
                                $imageUrl = $imageExists ? asset($feature->image) : asset('images/Default.jpg');
                                $isDefaultImage = basename($imageUrl) === 'Default.jpg';
                            @endphp
                            <span id="imageName">
                                {{ !$isDefaultImage && $imageExists ? basename($feature->image) : 'No image' }}
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4" required>{{ $feature->description }}</textarea>
                    </div>
                    <!-- Stat Items Section -->
                    <div style="border: #2C9DD4 1px solid; padding: 10px; border-radius: 5px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="highlight_number_1" name="highlight_number_1"
                               oninput="this.value = this.value.replace(/[^0-9./]/g, '').replace(/(\..*)\./g, '$1');"   value="{{ $feature->highlight_number_1 }}" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hightlight_text_1" name="hightlight_text_1"
                                value="{{ $feature->hightlight_text_1 }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" style="max-width: 400px;">
                                ...
                                <input type="text" class="form-control" id="highlight_icone_1" name="highlight_icone_1"
                                    ...
                                    value="{{ $feature->highlight_icone_1 }}" style="height: 40px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="highlight_number_2" name="highlight_number_2"
                              oninput="this.value = this.value.replace(/[^0-9./]/g, '').replace(/(\..*)\./g, '$1');"   value="{{ $feature->highlight_number_2 }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hightlight_text_2" name="hightlight_text_2"
                                value="{{ $feature->hightlight_text_2 }}" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group" style="max-width: 400px;">
                                ...
                                <input type="text" class="form-control" id="highlight_icone_2"
                                    ...
                                    value="{{ $feature->highlight_icone_2 }}" aria-describedby="stat-icon-preview-2"
                                    style="height: 40px;">
                                <button type="button" class="btn btn-outline-secondary" role="iconpicker"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="highlight_number_3" name="highlight_number_3"
                              oninput="this.value = this.value.replace(/[^0-9./]/g, '').replace(/(\..*)\./g, '$1');"   value="{{ $feature->highlight_number_3 }}" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hightlight_text_3" name="hightlight_text_3"
                                value="{{ $feature->hightlight_text_3 }}" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group" style="max-width: 400px;">
                                ...
                                <input type="text" class="form-control" id="highlight_icone_3"
                                    ...
                                    value="{{ $feature->highlight_icone_3 }}" aria-describedby="stat-icon-preview-3"
                                    style="height: 40px;">
                                <button type="button" class="btn btn-outline-secondary" role="iconpicker"
    ...
    <script>
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            fetch('{{ route('api.feature.update', $feature->id) }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                .then(data => {
                    Swal.close();
                    if (data.success) {
                        notify('success', 'Feature Section Details Updated Successfully!');
                        setTimeout(function() {
                        ...
                        notify('error', data.message ||
                            'There was an error updating the feature Section Detail page.');
                    }
                })
                .catch(error => {
                    Swal.close();
        ...
        if (deleteImageBtn) {
            deleteImageBtn.addEventListener('click', function() {
                window.deleteImageWithConfirm({
                    url: '{{ route('api.features.deleteImage', $feature->id) }}',
