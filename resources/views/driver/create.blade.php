...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <style>
                    #driverForm .password-input-group {
                        position: relative;
                    }

                    #driverForm .password-input-group .form-control {
                        padding-right: 42px;
                    }

                    #driverForm .password-input-group .input-group-append {
                        position: absolute;
                        right: 14px;
                        top: 50%;
                    ...
                    #driverForm .password-input-group .input-group-text {
                        border: 0;
    ...
    <script>
        ...
        $('#submitBtn').on('click', function() {
            ...
            else if (window.isDisplayDateBeforeToday(formData.get('license_expiry_date'))) showError('#license_expiry_date', 'License Expiry Date cannot be before ' + (window.formatTodayDisplayDate ? window.formatTodayDisplayDate() : new Date().toLocaleDateString('en-GB')));
