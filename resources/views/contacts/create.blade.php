                ...
                <form id="contactForm">
                    ...
                    <div class="form-group">
                        <label for="location_title" style="font-weight: bold;">Location Title <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="location_title" name="location_title" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="contact_2" style="font-weight: bold;">Contact 2 <span style="color: red;">*</span>
                        </label>
                    ...
                    <div class="form-group">
                        <label for="email_2" style="font-weight: bold;">Email 2 <span style="color: red;">*</span> </label>
                        <input type="email" class="form-control" id="email_2" name="email_2" required>
                    </div>
                    <div class="form-group">
                        <label for="contact_form_title" style="font-weight: bold;">Conatct Form Title <span style="color: red;">*</span>
                        </label>
                        <input type="text" class="form-control" id="contact_form_title" name="contact_form_title" required>
                    </div>
                    <div class="form-group">
                        <label for="contact_form_description" style="font-weight: bold;">Contact Form Description <span
                                style="color: red;">*</span></label>
                        <textarea class="form-control" id="contact_form_description" name="contact_form_description" rows="4" required></textarea>
                    </div>
    ...
    <script>
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            if (!formData.get('contact_form_title')) {
                document.getElementById('contact_form_title').nextElementSibling.textContent = 'Contact Title is required.';
                isValid = false;
            }
            ...
            var email = formData.get('email_2');
            ...
            fetch('{{ route('api.contacts.store') }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                .then(data => {
                    Swal.close();
                    if (data.success) {
                        notify('success', 'Contact info created Successfully!');
                        setTimeout(function() {
        ...
        document.getElementById('contact_2').addEventListener('input', function() {
            $(this).next('.error-message').text('');
        });
        ...
        document.getElementById('email_2').addEventListener('input', function() {
            $(this).next('.error-message').text('');
        });
