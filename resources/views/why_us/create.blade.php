            ...
            <div class="container">
                <nav aria-label="breadcrumb-nav">
                    <ol class="breadcrumb breadcrumb-style-2 my-20">
                        ...
                        <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Add Why Us Data</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="about-us-create-header">Add Why Us Data Details</h4>
            </div>
            <div class="card-body">
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            fetch('{{ route('api.why_us.store') }}', {
                ...
                .then(data => {
                    Swal.close();
                    if (data.success) {
                        notify('success', 'Why Us created Successfully!');
                        setTimeout(function() {
                            window.location.href = '{{ route('why_us.index') }}';
                        }, 1500);
                    } else {
                        notify('error', data.message || 'There was an error creating the Why us details.');
                    }
                })
                .catch(error => {
                    Swal.close();
