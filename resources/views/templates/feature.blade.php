         ...
         fetch('/api/frontend/features')
             ...
             .then(async payload => {
                 if (payload && payload.success && Array.isArray(payload.data) && payload.data.length >
                     ...
                     // Process image
                     const candidate = pageImage || feature?.image || '';
                     ...
                     <div class="row align-items-center mb-5">
                        <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                            <div class="features-intro">
                                ...
                                <div class="highlights-grid">
                                    <div class="highlight-item">
                                        <div class="highlight-number">${feature?.highlight_number_1 ?? ''}<i class="${feature?.highlight_icone_1 ?? ''} icon_css"></i></div>
                                        <div class="highlight-text">${feature?.hightlight_text_1 ?? ''}</div>
                                    </div>
                                    <div class="highlight-item">
                                        <div class="highlight-number">${feature?.highlight_number_2 ?? ''}<i class="${feature?.highlight_icone_2 ?? ''} icon_css"></i></div>
                                        <div class="highlight-text">${feature?.hightlight_text_2 ?? ''}</div>
                                    </div>
                                    <div class="highlight-item">
                                        <div class="highlight-number">${feature?.highlight_number_3 ?? ''}<i class="${feature?.highlight_icone_3 ?? ''} icon_css"></i></div>
                         ...
                         <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                            <div class="featured-image-container">
                                 <img src="${image}" alt="Digital Solutions" class="img-fluid" style="width:100%;height:100%;object-fit:contain;">
                                <div class="floating-badge">
                                    <i class="bi bi-award"></i>
                                    <span>Industry Leader</span>
                                </div>
                    ...
                    if (container) {
                        const hasServerContent = container.querySelector('.features-intro');
                        if (!hasServerContent) {
                            container.innerHTML = '';
                        ...
                        // If server content exists, keep the section visible as fallback
                    }
                }
             })
             .catch(() => {
