    ...
    <script>
        ...
        $('#updateBtn').on('click', function() {
            ...
            if (!$('input[name="rc_expiry_date"]').val()) {
                ...
                showError('input[name="rc_expiry_date"]', 'RC Expiry Date cannot be before ' + (window.formatTodayDisplayDate ? window.formatTodayDisplayDate() : new Date().toLocaleDateString('en-GB')));
            }
            ...
            if (!$('input[name="insurance_expiry_date"]').val()) {
                ...
                showError('input[name="insurance_expiry_date"]', 'Insurance Expiry Date cannot be before ' + (window.formatTodayDisplayDate ? window.formatTodayDisplayDate() : new Date().toLocaleDateString('en-GB')));
            }
