...
@section('content')
    ...
    <script>
        $('#submitBtn').on('click', function() {
            ...
            else if (window.isDisplayDateBeforeToday(formData.get('rc_expiry_date'))) showError('#rc_expiry_date', 'RC Expiry Date cannot be before ' + (window.formatTodayDisplayDate ? window.formatTodayDisplayDate() : new Date().toLocaleDateString('en-GB')));
            ...
            else if (window.isDisplayDateBeforeToday(formData.get('insurance_expiry_date'))) showError('#insurance_expiry_date', 'Insurance Expiry Date cannot be before ' + (window.formatTodayDisplayDate ? window.formatTodayDisplayDate() : new Date().toLocaleDateString('en-GB')));
