        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Advance Capability Section</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Advance Capability Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'advanceCapabilityTable';
                $DatbleVariable['TableCreateRoute'] = 'advance_capability.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Title', 'Description', 'Icon', 'Status Badge', 'Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#advanceCapabilityTable";
        let route = '{{ route('advance_capability.list') }}';
        let method = "POST";
        ...
        DatatableRenderFunction(
            ...
            pagination,
            multiDelete = true,
            deleteRoute = "advance_capability",
