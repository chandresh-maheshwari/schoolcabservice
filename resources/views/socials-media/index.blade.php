    ...
    <div class="breadcrumb-wrapper pb-0">
        ...
        <div class="card-body">
            @php
                ...
                $DatbleVariable['TableCreateRoute'] = 'socials-media.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Name', 'Social Link', 'Social Icon', 'Status', 'Actions'];
...
<script>
    $(document).ready(function() {
        ...
        let route = '{{ route('api.socials-media.list') }}';
        let method = "POST";
