...
@section('content')
            ...
            <div class="container">
                <nav aria-label="breadcrumb-nav">
                    <ol class="breadcrumb breadcrumb-style-2 my-20">
                        ...
                        <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Add Call To Action Data
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="about-us-create-header">Add Call To Action Data Details</h4>
            </div>
            <div class="card-body">
                <form id="heroSectionForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="badge_title" name="badge_title">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="max-width: 400px;">
                            ...
                            <input type="text" class="form-control" id="badge_icon" name="badge_icon"
                                placeholder="Select an icon..." aria-describedby="badge_icon_preview" style="height: 40px;">
                    ...
                    <div class="state_item_1 mt-1" style="border: #2C9DD4 1px solid; padding: 10px; border-radius: 5px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="stat_text_1" name="stat_text_1">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group" style="max-width: 400px;">
                                ...
                                <input type="text" class="form-control" id="stat_icon_1" name="stat_icon_1"
                                    placeholder="Select an icon..." aria-describedby="stat_icon_preview_1"
                                    style="height: 40px;">
                                <button type="button" class="btn btn-outline-secondary" role="iconpicker"
                    ...
                    <div class="state_item_2 mt-1" style="border: #2C9DD4 1px solid; padding: 10px; border-radius: 5px;">
                        ...
                        <div class="form-group">
                            ...
                            min="1"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/^0+/, '');" required>
                        </div>
                        <div class="form-group">
                            <label for="stat_text_2" style="font-weight: bold;">Stat Text 2</label>
                            <input type="text" class="form-control" id="stat_text_2" name="stat_text_2" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group" style="max-width: 400px;">
                                ...
                                <input type="text" class="form-control" id="stat_icon_2" name="stat_icon_2"
                                    placeholder="Select an icon..." aria-describedby="stat_icon_preview_2"
                                    style="height: 40px;">
                                <button type="button" class="btn btn-outline-secondary" role="iconpicker"
                    ...
                    <div class="button_data mt-1" style="border: #2C9DD4 1px solid; padding: 10px; border-radius: 5px;">
                        ...
                        <div class="form-group">
                            <label for="button_title" style="font-weight: bold;">Button Title<span
                                    style="color: red;">*</span></label>
                            <input type="text" class="form-control" id="button_title" name="button_title" required>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            fetch('{{ route('api.call_to_action.store') }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                .then(data => {
                    Swal.close();
                    if (data.success) {
                        notify('success', 'Call To Action created Successfully!');
                        setTimeout(function() {
                            window.location.href = '{{ route('call_to_action.index') }}';
                        }, 1500);
                    } else {
                        notify('error', data.message ||
                            'There was an error creating the Call To Action details.');
                    }
                })
                .catch(error => {
                    Swal.close();
