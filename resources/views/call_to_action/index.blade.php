        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Call To Action Section</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Call To Action Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'callToActionTable';
                $DatbleVariable['TableCreateRoute'] = 'call_to_action.create';
...
<script>
    $(document).ready(function() {
        let tableId = "#callToActionTable";
        let route = '{{ route('call_to_action.list') }}';
        let method = "POST";
