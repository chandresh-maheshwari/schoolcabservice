        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">How It Works Section </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">How It Works Section Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'howItWorksTable';
                $DatbleVariable['TableCreateRoute'] = 'howItWorks.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Title','Name','Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#howItWorksTable";
        let route = '{{ route('howItWorks.List') }}';
        let method = "POST";
