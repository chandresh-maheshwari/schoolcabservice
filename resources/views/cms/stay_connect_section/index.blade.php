        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Stay Connected</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="contacts-listing-header">Stay Connected Listing</h4>
                </div>

        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'stayConnectTable';
                $DatbleVariable['TableCreateRoute'] = '';
                $DatbleVariable['TableDeleteRoute'] = 'stayConnectSection.destroy';
                $DatbleVariable['TableRestoreRoute'] = 'stayConnectSection.restore';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Name', 'Company','Email'];
...
<script>
    $(document).ready(function() {
        let tableId = "#stayConnectTable";
        let route = '{{ route('api.stayConnectSection.list') }}';
        let method = "POST";
