        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Testimonial Section </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Testimonial Section Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'testimonailSectionTable';
                $DatbleVariable['TableCreateRoute'] = 'testimonialSection.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Name','Designation','Tagline','Rating','Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#testimonailSectionTable";
        let route = '{{ route('testimonialSection.List') }}';
        let method = "POST";
        ...
        DatatableRenderFunction(
            ...
            pagination,
            multiDelete = true,
            deleteRoute = "testimonialSection",
