        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item"><a class="breadcrumbLink" href="{{ route('socialMediaSection.index') }}">Socials</a></li>
        ...
        <div class="card-body">
            <form id="socialEditForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="social_name" name="social_name" value="{{ $social->social_name }}" required>
   ...
   document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('updateBtn').addEventListener('click', function () {
        ...
        if (!formData.get('social_name') || !formData.get('social_name').trim()) {
            document.getElementById('social_name-error-message').textContent = 'Social Name is required.';
            isValid = false;
        }

        if (!formData.get('social_link') || !formData.get('social_link').trim()) {
            document.getElementById('social_link-error-message').textContent = 'Social Link is required.';
            isValid = false;
        }

        if (!formData.get('social_icon')) {
            document.getElementById('social_icon-error-message').textContent = 'Social Icon is required.';
            isValid = false;
        }
