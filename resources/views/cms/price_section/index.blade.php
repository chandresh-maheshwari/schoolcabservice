        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Price Details </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Price Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'priceTable';
                $DatbleVariable['TableCreateRoute'] = 'priceSection.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'Title','Amount','Period','Is Most Popular','Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#priceTable";
        let route = '{{ route('priceSection.List') }}';
        let method = "POST";
