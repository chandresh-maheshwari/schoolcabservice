        ...
        <div class="container">
            <nav aria-label="breadcrumb-nav">
                <ol class="breadcrumb breadcrumb-style-2 my-20">
                    ...
                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Client Section </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Client Section Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'clientSectionTable';
                $DatbleVariable['TableCreateRoute'] = 'clientSection.create';
...
<script>
    $(document).ready(function() {
        let tableId = "#clientSectionTable";
        let route = '{{ route('clientSection.List') }}';
        let method = "POST";
