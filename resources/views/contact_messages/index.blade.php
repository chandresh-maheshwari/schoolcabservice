    ...
    <div class="breadcrumb-wrapper pb-0">
        ...
        <div class="card-body">
            @php
                ...
                $DatbleVariable['TableDeleteRoute'] = 'contact_messages.destroy';
                $DatbleVariable['TableRestoreRoute'] = 'contact_messages.restore';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'First Name','Email', 'Subject', 'Message'];
...
<script>
    $(document).ready(function() {
        ...
        let route = '{{ route('api.contact_messages.list') }}';
        let method = "POST";
