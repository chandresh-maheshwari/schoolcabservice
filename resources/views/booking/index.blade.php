        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="about-us-listing-header">Booking Detail Listing</h4>
                </div>
        <div class="card-body">
            @php
                $DatbleVariable['TableHader'] = '';
                $DatbleVariable['TableId'] = 'bookingTable';
                $DatbleVariable['TableCreateRoute'] = 'booking.create';
                $DatbleVariable['TableDeleteRoute'] = '';
                $DatbleVariable['TableRestoreRoute'] = '';

                $DatbleVariable['TableColumnName'] = ['Sr No.', 'School', 'Package Type','Booking Type', 'Latitude', 'Longitude','Contact Number','Actions'];
...
<script>
    $(document).ready(function() {
        let tableId = "#bookingTable";
        let route = '{{ route('booking.list') }}';
        let method = "POST";
