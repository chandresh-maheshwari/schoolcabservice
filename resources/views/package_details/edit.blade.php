...
@section('content')
    ...
    @php
        $selectedPackageType = old('package_type', $package->package_type ?? '');
        $selectedValidity = old('validity_days', $package->validity_days);
                ...
                <form id="packageDetailForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="booking_type" name="booking_type">
                            ...
                            <option value="Pickup Only" {{ ($package->booking_type ?? '') === 'Pickup Only' ? 'selected' : '' }}>Pickup Only</option>
                            <option value="Drop Only" {{ ($package->booking_type ?? '') === 'Drop Only' ? 'selected' : '' }}>Drop Only</option>
                            <option value="Pickup &amp; Drop" {{ ($package->booking_type ?? '') === 'Pickup & Drop' ? 'selected' : '' }}>Pickup &amp; Drop</option>
                        </select>
                    </div>
