...
@section('content')
            ...
            <div class="container">
                <nav aria-label="breadcrumb-nav">
                    <ol class="breadcrumb breadcrumb-style-2 my-20">
                        ...
                        <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Add Alternative</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="about-us-create-header">Add Alternative Details</h4>
            </div>
            <div class="card-body">
                <form id="heroSectionForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="alternative_icon" style="font-weight: bold;">Alternative Icon<span
                                style="color: red;">*</span></label>
                        <div class="input-group" style="max-width: 400px;">
                            ...
                            <button type="button" class="btn btn-outline-secondary" role="iconpicker"
                                data-iconset="fontawesome5" data-input="alternative_icon" data-preview="stat-icon-preview-1"
                    ...
                    <div class="form-group">
                        <label for="image" style="font-weight: bold;">Upload Image <span
                                style="color: red;">*</span></label>
                        <div class="mt-2">
                            <button type="button" class="btn btn-primary" id="uploadImageBtn"
                                onclick="document.getElementById('image').click();"
    ...
    <script>
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            fetch('{{ route('api.alternative.store') }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                .then(data => {
                    Swal.close();
                    if (data.success) {
                        notify('success', 'Alternative created Successfully!');
                        setTimeout(function() {
                            window.location.href = '{{ route('alternative.index') }}';
                        }, 1500);
                    } else {
                        notify('error', data.message || 'There was an error creating the Alternative details.');
                    }
                })
                .catch(error => {
                    Swal.close();
