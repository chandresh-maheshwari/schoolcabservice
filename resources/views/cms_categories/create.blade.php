...
{{-- <div class="container-fluid" style="width: 101%; padding-right: 7px; padding-left: 0px; margin-right: auto; margin-left: auto; margin-top: 9px;">
    <div class="card" style="background-color: #f8f9fa; border-color: #e3e6f0;">
        <div class="card-header" style="background-color: #a9b5df; color: white; padding: 10px 15px 1px;">
            <h2 class="cms-category-create-header" style="text-align: center; font-size: 1.5em; margin-bottom: 6px; font-weight: bold; color: #2d336b;">Create CMS Category</h2>
        </div> --}}
    ...
    <div class="card" >
        ...
        <div class="card-body">
            <form id="clientForm">
                ...
                <div class="form-group">
                    <label for="image" style="font-weight: bold;">Client Image <span style="color: red;">*</span></label>
                    <div class="mt-2">
...
<script>
    ...
    document.getElementById('submitBtn').addEventListener('click', function() {
        ...
        .then(data => {
            ...
            if (data.success) {
                Swal.close();
                    notify('success', 'CMS Category created Successfully!');
                    setTimeout(function() {
                ...
                Swal.close();
                notify('error', 'There was an error creating the CMS category.');
            }
        })
        .catch(error => {
            Swal.close();
