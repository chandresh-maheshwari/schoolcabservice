                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="640"
                    ...
                    <tr>
                        <td style="padding:18px 22px;background:#2d336b;color:#ffffff;">
                            ...
                            <div style="font-size:13px;opacity:.9;line-height:18px;margin-top:4px;">{{ $roleLabel }} Access</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:22px;">
                            ...
                            <div style="font-size:13px;line-height:20px;color:#374151;margin:0 0 18px 0;">
                                Below are your mobile application login details. Keep this email safe and do not share it with anyone.
                            </div>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td style="padding:14px 16px;background:#f9fafb;border-bottom:1px solid #e5e7eb;">
                                        <div style="font-size:12px;color:#6b7280;">Login Email / Username</div>
                                        <div style="font-size:14px;font-weight:700;margin-top:4px;color:#111827;">{{ $loginId }}</div>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <div style="font-size:12px;line-height:18px;color:#6b7280;margin-top:12px;">
                                Use these credentials in the mobile application login screen.
                            </div>
                        </td>
                    </tr>
                    <tr>
